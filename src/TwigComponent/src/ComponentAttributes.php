...
final class ComponentAttributes implements \Stringable, \IteratorAggregate, \Countable
{
    ...
    /**
     * @param array<string, string|bool|int|float|iterable|\Stringable|\BackedEnum|AttributeValueInterface|null> $attributes
     */
    ...
    /**
     * @return array<string, string|bool|int|float|iterable|\Stringable|\BackedEnum|AttributeValueInterface|null>
     */
