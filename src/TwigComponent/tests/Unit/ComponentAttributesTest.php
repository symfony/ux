...
final class ComponentAttributesTest extends TestCase
{
    ...
    public function testOutputMatchesHtmlAttr(array $attributes): void
    {
    ...
    public function testRenderOmittedAttributeReturnsNull(): void
    {
    ...
    public function testRenderResolvesValueLikeHtmlAttr(): void
    {
        $attributes = new ComponentAttributes([
            'class' => ['a', 'b'],
            'hidden' => true,
