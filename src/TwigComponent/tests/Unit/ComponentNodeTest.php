...
final class ComponentNodeTest extends TestCase
{
     ...
     */
    public function testCompilesToYieldWhenTheEnvironmentOnlySupportsYield(): void
    {
    ...
    public function testCompilesToYieldWhenYieldIsEnabledOnTwig3(): void
    {
        if (Environment::MAJOR_VERSION >= 4) {
     ...
     */
    public function testKeepsTheLegacyDisplayPathWhenYieldIsDisabledOnTwig3(): void
    {
        if (Environment::MAJOR_VERSION >= 4) {
