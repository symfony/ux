import { n as UploadSuspendedError, r as Uploader, t as UploadCancelledError } from "./uploader-CwygjnFR.js";
...
var upload_controller_default = class extends Controller {
	...
	uploader;
	previewCache;
	cachedBlobUrls = /* @__PURE__ */ new Map();
	uploads = /* @__PURE__ */ new Map();
	fileCounter = 0;
	fileByFile = /* @__PURE__ */ new Map();
	dragCounter = 0;
	fileProgress = /* @__PURE__ */ new Map();
...
export { extractFilesFromClipboard as n, renameAnonymousFile as r, upload_controller_default as t };
