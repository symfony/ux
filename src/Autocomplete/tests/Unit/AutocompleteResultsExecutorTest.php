...
class AutocompleteResultsExecutorTest extends TestCase
{
    ...
    public function testItExecutesSecurityForGenericAutocompleter(): void
    {
    ...
    public function testItDelegatesToGenericAutocompleter(): void
    {
    ...
    public function testGenericAutocompleterWithoutSecurity(): void
    {
