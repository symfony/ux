...
export abstract class AbstractEditorController<T = any> extends Controller<HTMLElement> {
    ...
    async connect(): Promise<void> {
        this.element.dispatchEvent(
            new CustomEvent('ux:editor:pre-connect', {
                bubbles: true,
        ...
        this.element.dispatchEvent(
            new CustomEvent('ux:editor:connect', {
                bubbles: true,
    ...
    syncInput(): void {
        ...
        const finalize = (v: string | object) => {
            ...
            this.element.dispatchEvent(
                new CustomEvent('ux:editor:change', {
                    bubbles: true,
    ...
    async configValueChanged(newCfg: Record<string, unknown>, oldCfg?: Record<string, unknown>): Promise<void> {
        ...
        this.element.dispatchEvent(
            new CustomEvent('ux:editor:remount', {
                bubbles: true,
    ...
    async disconnect(): Promise<void> {
        if (this.instance !== undefined) {
            await this.destroyEditor(this.instance);
            this.element.dispatchEvent(
                new CustomEvent('ux:editor:destroy', { bubbles: true, detail: { bridgeId: this.bridgeIdValue } })
            );
