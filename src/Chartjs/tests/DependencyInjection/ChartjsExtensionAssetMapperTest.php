...
namespace Symfony\UX\Chartjs\Tests\DependencyInjection;

use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\Filesystem\Filesystem;
use Symfony\UX\Chartjs\DependencyInjection\ChartjsExtension;

/**
 * @author Simon André <smn.andre@gmail.com>
 */
final class ChartjsExtensionAssetMapperTest extends TestCase
{
    public function testPrependsPathsWithAssetMapperBundle(): void
    {
        ...
        self::assertSame('@symfony/ux-chartjs', array_values($config[0]['asset_mapper']['paths'])[0]);
    }

    public function testPrependsPathsWithLegacyFrameworkBundle(): void
    {
        $filesystem = new Filesystem();
        $directory = sys_get_temp_dir().'/chartjs-framework-'.bin2hex(random_bytes(6));
    ...
    private function prepend(array $bundles): array
    {
        ...
        new ChartjsExtension()->prepend($container);
