...
#[AsCommand(
    ...
    description: 'Search icons and icon sets from iconify.design',
)]
final class SearchIconCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(
                <<<EOF
The <info>%command.name%</info> command search icon sets and icons from iconify.design.
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->write(sprintf('Searching <comment>%s</comment> icons "<comment>%s</comment>" on Iconify...', $iconSet['name'], $name));
        try {
        ...
        $io->write(' <fg=bright-green;options=bold>✓</>'.\PHP_EOL);
