...
/**
 * Warns about recipes shipping no "README.md"; their documentation is then generated
        ...
        foreach ($kit->getRecipes() as $recipe) {
            if (null === $recipe->doc) {
                yield new LintIssue(
                    ...
                    message: 'Recipe has no "README.md"; its documentation is generated from the manifest and examples only.',
                    recipe: $recipe->name,
                );
            }
        }
