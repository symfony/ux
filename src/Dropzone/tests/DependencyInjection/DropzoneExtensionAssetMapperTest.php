...
namespace Symfony\UX\Dropzone\Tests\DependencyInjection;

use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\Filesystem\Filesystem;
use Symfony\UX\Dropzone\DependencyInjection\DropzoneExtension;

/**
 * @author Simon André <smn.andre@gmail.com>
 */
final class DropzoneExtensionAssetMapperTest extends TestCase
{
    public function testPrependsPathsWithAssetMapperBundle(): void
    {
        ...
        self::assertSame('@symfony/ux-dropzone', array_values($config[0]['asset_mapper']['paths'])[0]);
    }

    public function testPrependsPathsWithLegacyFrameworkBundle(): void
    {
        $filesystem = new Filesystem();
        $directory = sys_get_temp_dir().'/dropzone-framework-'.bin2hex(random_bytes(6));
    ...
    private function prepend(array $bundles): array
    {
        ...
        new DropzoneExtension()->prepend($container);
