...
final class ResizeGeometryCalculatorTest extends TestCase
{
    ...
    public function testFitPreservesRatioAndDoesNotUpscale()
    {
    ...
    public function testFillUsesTargetCanvasWithoutDistortion()
    {
    ...
    public function testCropUsesFocalPoint()
    {
    ...
    public function testCropPreservesRequestedRatioWithoutUpscaling()
    {
    ...
    public function testPercentageFocalPoint()
    {
    ...
    public function testNamedFocalPoints()
    {
    ...
    public function testRejectsInvalidFocalPoint()
    {
    ...
    public function testRejectsOutOfRangeFocalPoint()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testCalculatesMissingTargetDimension()
    {
    ...
    public function testCropPortraitSource()
    {
    ...
    public function testRejectsInvalidDimensions()
    {
        $this->expectException(\InvalidArgumentException::class);
