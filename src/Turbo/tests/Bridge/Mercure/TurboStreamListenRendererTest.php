...
final class TurboStreamListenRendererTest extends KernelTestCase
{
    ...
    public static function provideTestCases(): iterable
    {
        ...
        // Twig 3 drops the backslash of an unknown escape sequence, Twig 4 keeps it: 'App\Entity\Book' reaches the renderer as written
        // @phpstan-ignore greaterOrEqual.alwaysFalse, greaterOrEqual.alwaysTrue (PHPStan only ever sees the installed Twig)
        $classTopic = \Twig\Environment::MAJOR_VERSION >= 4 ? 'App\\Entity\\Book' : 'AppEntityBook';
        // @phpstan-ignore greaterOrEqual.alwaysFalse, greaterOrEqual.alwaysTrue (PHPStan only ever sees the installed Twig)
        $classTopicJson = \Twig\Environment::MAJOR_VERSION >= 4 ? 'App\\\\Entity\\\\Book' : 'AppEntityBook';
