...
//#endregion
export { DomainType, DomainsOf, LocaleOf, LocaleType, Message, NoParametersType, ParametersOf, ParametersType, RemoveIntlIcuSuffix, TranslationsType, getLocale, getLocaleFallbacks, setLocale, setLocaleFallbacks, throwWhenNotFound, trans };