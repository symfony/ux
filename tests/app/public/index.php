...
class index extends Kernel
{
    ...
    protected function configureContainer(ContainerConfigurator $container): void
    {
        ...
        $container->parameters()->set('env(MERCURE_PUBLISH_URL)', 'http://localhost:3000/.well-known/mercure');
        $container->parameters()->set('env(MERCURE_JWT_TOKEN)', 'eyJhbGciOiJIUzI1NiJ9.eyJtZXJjdXJlIjp7InB1Ymxpc2giOlsiKiJdfX0.vhMwOaN5K68BTIhWokMLOeOJO4EPfT64brd8euJOA4M');
